# Generated by Django 4.1.3 on 2023-12-21 19:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'unique_together': {('user', 'phone', 'city', 'street', 'house', 'structure', 'building', 'apartment')},
            },
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('datetime', models.DateTimeField(auto_now_add=True, verbose_name='Дата и время создания заказа')),
                ('state', models.CharField(choices=[('basket', 'В корзине'), ('new', 'Новый'), ('confirmed', 'Подтверждён'), ('assembled', 'Собран'), ('sent', 'Отправлен'), ('delivered', 'Доставлен'), ('canceled', 'Отменен')], default='new', max_length=30, verbose_name='Статус заказа')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=80, verbose_name='Наименивание')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('external_id', models.PositiveIntegerField(verbose_name='внешний артикул')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('token', models.CharField(db_index=True, max_length=64, unique=True, verbose_name='Key')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='product_parameters', to='backend.productinfo', verbose_name='Продукт')),
            ],
            options={
                'verbose_name': 'Параметр',
